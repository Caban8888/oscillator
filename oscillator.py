...
plt.figure(2)
plt.plot(omegas, undamped_vibration_energy(omegas), label="Amplituda drgań nietłumionych")
plt.plot(omegas, damped_vibration_energy(omegas, b), label="Amplituda drgań tłumionych")
plt.xlabel("Częstość wymuszająca (Hz)")
plt.ylabel("Amplituda (m)")
